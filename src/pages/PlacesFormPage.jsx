    ...
    return (
        <div>
            ...
            <form onSubmit={savePlace}>
                {preInput('Title', 'Title for your place. Better be short and Sweet')}
                <input type='text'
                    value={title}
                    onChange={ev => setTitle(ev.target.value)} placeholder='title, for Ex: My lovely Aparatment' />
                ...
                {preInput('ExtraInfo', 'let your customers know about your place !!!')}
                <textarea
                    value={extraInfo}
                    onChange={ev => setExtraInfo(ev.target.value)} />
                {preInput('CheckIn', 'add chekcin and checkout timings')}
